...
namespace Lexxusss\LaravelClickHouse\Database\Eloquent;
...
class Builder
{
     ...
     *
     * @var \Lexxusss\LaravelClickHouse\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Lexxusss\LaravelClickHouse\Database\Eloquent\Model
     */
    protected $model;
